...
export default class KK extends Component {
  ...
  render() {
    return (
        ...
        <TouchableOpacity style={styles.container} activeOpacity={0.5} onPress={()=> this.props.navigation.navigate("AnggotaKeluarga")}>
            ...
            <View style={{flex:2,
                ...
                <View style={{}}>
                    <Text style={{alignSelf:'flex-end'}}>Anggota Keluarga</Text>
                    <Text style={{alignSelf:'flex-end', fontWeight: "700", fontSize: normalize(15)}}>3 Orang</Text>
                </View>
            </View>
